...
import { getAllRequests } from '../../store/slices/leaveSlice';
import { format } from 'date-fns';

const AllRequests = () => {
    const dispatch = useDispatch();
    const { requests, pagination, isLoading } = useSelector((state) => state.leave);
            ...
            <Paper sx={{ p: 3, mb: 2 }}>
                <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', alignItems: 'center' }}>
                    ...
                    <Button
                        ...
                        onClick={() => dispatch(getAllRequests(filters))}
                    >
                        Refresh
                    </Button>
                </Box>
                        ...
                        {isLoading ? (
                            ...
                            requests.map((request) => (
                                <TableRow key={request._id} hover>
                                    ...
                                    <TableCell sx={{ maxWidth: 200 }}>{request.managerComment || '-'}</TableCell>
